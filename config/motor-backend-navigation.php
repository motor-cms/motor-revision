...
return [
    'items' => [
        5 => [
            'slug'        => 'revision',
            'name'        => 'motor-revision.global.revision',
            'icon'        => 'paper-plane',
            'route'       => null,
            'roles'       => ['SuperAdmin'],
            ...
            'items'       => [
                100 => [
                    'slug'        => 'tickets',
                    'name'        => 'motor-revision.tickets.tickets',
                    'icon'        => 'fa fa-plus',
                ...
                200 => [ // <-- !!! replace 531 with your own sort position !!!
                         'slug'        => 'airports',
                         'name'        => 'motor-revision.airports.airports',
                         'icon'        => 'fa fa-plus',
                ...
                300 => [ // <-- !!! replace 341 with your own sort position !!!
                         'slug'        => 'travelers',
                         'name'        => 'motor-revision.travelers.travelers',
                         'icon'        => 'fa fa-plus',
                ...
                400 => [ // <-- !!! replace 165 with your own sort position !!!
                         'slug'        => 'shuttles',
                         'name'        => 'motor-revision.shuttles.shuttles',
                         'icon'        => 'fa fa-plus',
                ...
                500 => [ // <-- !!! replace 187 with your own sort position !!!
                         'slug'        => 'rides',
                         'name'        => 'motor-revision.rides.rides',
                         'icon'        => 'fa fa-plus',
                ...
                600 => [ // <-- !!! replace 371 with your own sort position !!!
                         'slug'        => 'sponsors',
                         'name'        => 'motor-revision.sponsors.sponsors',
                         'icon'        => 'fa fa-plus',
                ...
                700 => [ // <-- !!! replace 290 with your own sort position !!!
                         'slug'        => 'hotels',
                         'name'        => 'motor-revision.hotels.hotels',
                         'icon'        => 'fa fa-plus',

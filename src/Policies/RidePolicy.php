...
class RidePolicy
{
    ...
    {
        return $user->hasPermissionTo('rides.read');
    }
     ...
     *
     * @param \Motor\Backend\Models\User $user
     * @param \Motor\Revision\Models\Ride $ride
     * @return mixed
     */
    ...
    {
        return $user->hasPermissionTo('rides.write');
    }
    ...
    {
        return $user->hasPermissionTo('rides.delete');
    }

    ...
    public function buildForm()
    {
        $this
            ...
            ->add('shuttle_id', 'select', [
                ...
                'choices' => Shuttle::pluck('name', 'id')->toArray(),
            ...
            ->add(
                'email',
                'text',
                [ 'label' => trans('motor-revision::backend/travelers.email'), 'rules' => 'required' ]
            )
            ->add(
                'mobile_phone',
                'text',
            ...
            ->add(
                'flight_time',
                'datetimepicker',
                [ 'label' => trans('motor-revision::backend/travelers.flight_time'), 'rules' => 'required' ]
            )
            ->add(
                'flight_number',
                'text',
                [ 'label' => trans('motor-revision::backend/travelers.flight_number'), 'rules' => 'required' ]
            )
            ->add(
                'number_of_people',
                'text',
